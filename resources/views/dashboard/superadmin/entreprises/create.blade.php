...
@section('title', 'Créer une entreprise - Super Admin')
...
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h3 class="mb-0">Nouvelle Entreprise</h3>
            </div>
            <div class="col-sm-6">
...
<div class="app-content">
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <p class="text-muted">Formulaire de création d'entreprise en cours de développement.</p>
            </div>
        </div>
    </div>
</div>
