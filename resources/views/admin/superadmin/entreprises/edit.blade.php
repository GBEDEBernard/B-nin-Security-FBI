...
@section('title', 'Modifier l\'Entreprise - Super Admin')
...
<style>
    ...
    [data-bs-theme="dark"] .form-wizard .nav-tabs {
        border-bottom-color: #2a2d3a;
    }

    [data-bs-theme="dark"] .form-wizard .nav-tabs .nav-link {
        color: #8b90a8;
    }

    [data-bs-theme="dark"] .form-wizard .nav-tabs .nav-link:hover,
    [data-bs-theme="dark"] .form-wizard .nav-tabs .nav-link.active {
        color: #4ade80;
    }
    ...
    [data-bs-theme="dark"] .preview-logo {
        background: #1a1d27;
        border-color: #2a2d3a;
    }

    [data-bs-theme="dark"] .preview-logo:hover {
        border-color: #198754;
    ...
    [data-bs-theme="dark"] .package-card.selected {
        border-color: #198754;
    ...
    [data-bs-theme="dark"] .tab-content .form-card h5,
    [data-bs-theme="dark"] .tab-content .form-card h6 {
        color: #f0f2f8;
    }

    [data-bs-theme="dark"] .tab-content .text-muted {
        color: #8b90a8 !important;
    }
...
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h3 class="mb-0"><i class="bi bi-building-fill-gear me-2"></i>Modifier l'Entreprise</h3>
            </div>
            <div class="col-sm-6">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4 p-3 bg-light rounded-3">
                        <div class="d-flex align-items-center">
                            @if($entreprise->logo)
                            <img src="{{ $entreprise->logoUrl }}" alt="Logo" class="me-3 rounded" style="width: 50px; height: 50px; object-fit: cover;">
                            @else
                        ...
                        <div>
                            ...
                            <span class="statut-badge bg-success bg-opacity-10 text-success">
                                <i class="bi bi-check-circle me-1"></i> Active
                            </span>
                            @else
                            <span class="statut-badge bg-secondary bg-opacity-10 text-secondary">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="forme_juridique" name="forme_juridique">
                                        ...
                                        <option value="SNC" {{ old('forme_juridique', $entreprise->forme_juridique) == 'SNC' ? 'selected' : '' }}>SNC</option>
                                        <option value="EI" {{ old('forme_juridique', $entreprise->forme_juridique) == 'EI' ? 'selected' : '' }}>EI (Entreprise Individuelle)</option>
                                        <option value="GIE" {{ old('forme_juridique', $entreprise->forme_juridique) == 'GIE' ? 'selected' : '' }}>GIE</option>
                                        <option value="Association" {{ old('forme_juridique', $entreprise->forme_juridique) == 'Association' ? 'selected' : '' }}>Association</option>
                                        <option value="Autre" {{ old('forme_juridique', $entreprise->forme_juridique) == 'Autre' ? 'selected' : '' }}>Autre</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="d-flex align-items-start gap-4">
                                        <div class="preview-logo {{ $entreprise->logo ? 'has-image' : '' }}" onclick="document.getElementById('logo').click()">
                                            @if($entreprise->logo)
                                            <img src="{{ $entreprise->logoUrl }}" alt="Logo actuel" class="current-logo">
                                            @else
                                        ...
                                        <div>
                                            ...
                                            @if($entreprise->logo)
                                            <small class="text-info">Laissez vide pour conserver l'actuel</small>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                            <div class="row g-4">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" id="adresse" name="adresse" rows="2">{{ old('adresse', $entreprise->adresse) }}</textarea>
                                </div>

                                <!-- Ville -->
                                <div class="col-md-4">
                                    <label for="ville" class="form-label">Ville</label>
                                    <input type="text" class="form-control" id="ville" name="ville" value="{{ old('ville', $entreprise->ville) }}">
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" id="pays" name="pays">
                                        <option value="Bénin" {{ old('pays', $entreprise->pays ?? 'Bénin') == 'Bénin' ? 'selected' : '' }}>Bénin</option>
                                        <option value="Togo" {{ old('pays', $entreprise->pays) == 'Togo' ? 'selected' : '' }}>Togo</option>
                                        <option value="Nigeria" {{ old('pays', $entreprise->pays) == 'Nigeria' ? 'selected' : '' }}>Nigeria</option>
                                        <option value="Ghana" {{ old('pays', $entreprise->pays) == 'Ghana' ? 'selected' : '' }}>Ghana</option>
                                        <option value="Côte d'Ivoire" {{ old('pays', $entreprise->pays) == "Côte d'Ivoire" ? 'selected' : '' }}>Côte d'Ivoire</option>
