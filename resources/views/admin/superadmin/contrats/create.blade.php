...
@section('title', 'Nouveau Contrat - Super Admin')
...
<div class="app-content">
    <div class="container-fluid">
        ...
        <form action="{{ route('admin.superadmin.contrats.store') }}" method="POST" class="form-wizard">
            @csrf
            ...
            <div class="card form-card">
                <div class="card-body p-4">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select @error('client_id') is-invalid @enderror"
                                        ...
                                        @endphp
                                        @if($selectedClient)
                                        <option value="{{ $selectedClient->id }}" selected>{{ $selectedClient->nom }}</option>
                                        @endif
                                        @endif
                                    </select>
                                    @error('client_id')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('intitule') is-invalid @enderror"
                                        ...
                                        value="{{ old('intitule') }}" placeholder="Contrat de prestation de services" required>
                                    @error('intitule')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" id="description_prestation" name="description_prestation"
                                        rows="4" placeholder="Décrivez les services de sécurité à fournir...">{{ old('description_prestation') }}</textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    <div class="form-check form-switch mt-4">
                                        <input class="form-check-input" type="checkbox" id="est_renouvelable"
                                            name="est_renouvelable" value="1" {{ old('est_renouvelable') ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="duree_preavis"
                                        name="duree_preavis" value="{{ old('duree_preavis', 30) }}" min="0">
                                </div>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control @error('montant_mensuel_ht') is-invalid @enderror"
                                            ...
                                            value="{{ old('montant_mensuel_ht') }}" min="0" step="100" required>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" id="conditions_particulieres" name="conditions_particulieres"
                                        rows="4" placeholder="Conditions particulières du contrat...">{{ old('conditions_particulieres') }}</textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="signataire_client_nom"
                                        name="signataire_client_nom" value="{{ old('signataire_client_nom') }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="signataire_client_fonction"
                                        name="signataire_client_fonction" value="{{ old('signataire_client_fonction') }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" class="form-control" id="date_signature"
                                        name="date_signature" value="{{ old('date_signature') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="wizard-buttons">
                        <div>
                            <a href="{{ route('admin.superadmin.contrats.index') }}" class="btn btn-outline-secondary">
                                <i class="bi bi-arrow-left me-1"></i> Annuler
                            </a>
                        </div>
                        <div>
                            <button type="submit" class="btn btn-success btn-create">
                                <i class="bi bi-check-circle me-1"></i> Créer le contrat
                            </button>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    // Charger les clients si une entreprise est déjà sélectionnée
