            ...
            <div class="col-12">
                <div class="dashboard-card p-4">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-6 col-md-3">
                            <a href="{{ route('admin.agent.conges.index') }}" class="quick-action-btn w-100">
                                <i class="bi bi-calendar-plus text-warning"></i><span>Demander Congé</span>
                            </a>
                        </div>
                        <div class="col-6 col-md-3">
                            <a href="{{ route('admin.agent.missions.index') }}" class="quick-action-btn w-100">
            ...
            <div class="col-lg-8">
                <div class="dashboard-card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <a href="{{ route('admin.agent.missions.index') }}" class="btn btn-sm btn-outline-primary">Voir tout</a>
                    </div>
                ...
                <div class="dashboard-card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-grid mt-3">
                            <a href="{{ route('admin.agent.conges.index') }}" class="btn btn-outline-primary btn-sm">
            ...
            <div class="col-12">
                <div class="dashboard-card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <a href="{{ route('admin.agent.pointages.index') }}" class="btn btn-sm btn-outline-info">Voir tout</a>
                    </div>
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
