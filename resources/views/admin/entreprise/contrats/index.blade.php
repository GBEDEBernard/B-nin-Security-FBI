...
<div class="app-content">
    <div class="container-fluid">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h3 class="mb-0 fw-bold text-warning">{{ $stats['brouillon'] }}</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h3 class="mb-0 fw-bold text-danger">{{ $stats['resilies'] }}</h3>
                            </div>
        ...
        <div class="card contract-card mb-4">
            <div class="card-body">
                <form method="GET" action="{{ route('admin.entreprise.contrats.index') }}" class="row g-3">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-3">
                        <a href="{{ route('admin.entreprise.contrats.create') }}" class="btn btn-success">
                    ...
                    <table class="table data-table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>{{ $contrat->intitule }}</div>
                                    <small class="text-muted">{{ $contrat->nombre_agents_requis }} agent(s)</small>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div>{{ $contrat->date_debut?->format('d/m/Y') ?? 'N/A' }}</div>
                                    <small class="text-muted">au {{ $contrat->date_fin?->format('d/m/Y') ?? 'N/A' }}</small>
                                </td>
                                <td>
                                ...
                                <td class="text-end">
                                    <div class="btn-group">
                                        <a href="{{ route('admin.entreprise.contrats.show', $contrat->id) }}" class="btn btn-sm btn-outline-primary btn-action" title="Voir">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <a href="{{ route('admin.entreprise.contrats.edit', $contrat->id) }}" class="btn btn-sm btn-outline-success btn-action" title="Modifier">
