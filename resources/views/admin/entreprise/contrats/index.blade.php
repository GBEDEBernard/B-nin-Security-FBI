...
<style>
    ...
    .stat-card .stat-label {
        ...
        letter-spacing: 1px; color: var(--bs-secondary-color); margin-bottom: 0.25rem;
    }
    ...
    .btn-filter:hover { transform: translateY(-1px); box-shadow: 0 6px 16px rgba(25,135,84,0.3); color: white; }
    .btn-reset {
        border: 2px solid var(--bs-border-color); border-radius: 12px;
        padding: 0.65rem 1.25rem; background: var(--bs-body-bg);
        color: var(--bs-secondary-color); font-weight: 600; font-size: 0.9rem;
        transition: all 0.25s;
    }
    .btn-reset:hover { border-color: #198754; color: #198754; background: rgba(25,135,84,0.05); }
    .btn-new-contrat {
        background: linear-gradient(135deg, #198754 0%, #20c997 100%);
        border: none; border-radius: 12px; padding: 0.65rem 1.5rem;
    ...
    .btn-new-contrat:hover { transform: translateY(-2px); box-shadow: 0 8px 20px rgba(25,135,84,0.35); color: white; }
    ...
    .client-chip {
        ...
        background: rgba(13,110,253,0.08); color: #0d6efd;
    ...
    .badge-dot { width: 6px; height: 6px; border-radius: 50%; display: inline-block; background: currentColor; }

    /* ── Montant ── */
    .montant-value { font-weight: 700; color: var(--bs-body-color); font-size: 0.9rem; }
    .montant-unit  { font-size: 0.75rem; color: var(--bs-secondary-color); }

    /* ── Actions ── */
    .btn-action-group { display: flex; gap: 0.35rem; justify-content: flex-end; }
    .btn-act {
        width: 34px; height: 34px; border-radius: 10px;
        display: flex; align-items: center; justify-content: center;
        font-size: 0.875rem; border: 2px solid transparent;
        transition: all 0.2s; cursor: pointer;
        text-decoration: none;
    }
    .btn-act-view  { background: rgba(13,110,253,0.08);  color: #0d6efd;  border-color: rgba(13,110,253,0.15); }
    .btn-act-edit  { background: rgba(25,135,84,0.08);   color: #198754;  border-color: rgba(25,135,84,0.15); }
    .btn-act-del   { background: rgba(220,53,69,0.08);   color: #dc3545;  border-color: rgba(220,53,69,0.15); }
    .btn-act:hover { transform: translateY(-2px); filter: brightness(1.1); }
    .btn-act-view:hover  { background: rgba(13,110,253,0.15); }
    .btn-act-edit:hover  { background: rgba(25,135,84,0.15); }
    .btn-act-del:hover   { background: rgba(220,53,69,0.15); }
    ...
    .empty-state .empty-icon {
        ...
        background: rgba(25,135,84,0.08);
        display: flex; align-items: center; justify-content: center;
        font-size: 2.5rem; color: #198754;
        margin: 0 auto 1.5rem;
    }
    .empty-state h5 { font-weight: 700; color: var(--bs-body-color); margin-bottom: 0.5rem; }
    .empty-state p  { color: var(--bs-secondary-color); margin-bottom: 1.5rem; }
    ...
    /* ── Expiration warning ── */
    .expiry-warning { color: #fd7e14; font-size: 0.75rem; font-weight: 600; }
    .expiry-expired { color: #dc3545; font-size: 0.75rem; font-weight: 600; }

    /* ── Modal ── */
    .modal-content { border-radius: 20px; border: none; box-shadow: 0 20px 60px rgba(0,0,0,0.2); }
    .modal-header { border-bottom: 2px solid var(--bs-border-color); padding: 1.25rem 1.5rem; border-radius: 20px 20px 0 0; }
    .modal-body { padding: 1.5rem; }
    .modal-footer { border-top: 2px solid var(--bs-border-color); padding: 1.25rem 1.5rem; }
    .btn-confirm-del {
        background: linear-gradient(135deg, #dc3545, #c82333);
        border: none; border-radius: 10px; color: white;
        font-weight: 600; padding: 0.65rem 1.5rem; transition: all 0.2s;
    }
    .btn-confirm-del:hover { transform: translateY(-1px); box-shadow: 0 6px 16px rgba(220,53,69,0.3); color: white; }
    .btn-modal-cancel {
        border: 2px solid var(--bs-border-color); border-radius: 10px;
        background: var(--bs-body-bg); color: var(--bs-body-color);
        font-weight: 600; padding: 0.65rem 1.25rem; transition: all 0.2s;
    }
    .btn-modal-cancel:hover { background: var(--bs-tertiary-bg); }
