...
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h3 class="mb-0"><i class="bi bi-geo-alt me-2"></i>Nouveau Site</h3>
            </div>
            <div class="col-sm-6">
...
<div class="app-content">
    <div class="container-fluid">
        <form action="{{ route('admin.entreprise.sites.store') }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-lg-8">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <select name="client_id" class="form-select" required>
                                        ...
                                        <option value="{{ $client->id }}" {{ old('client_id', $clientId) == $client->id ? 'selected' : '' }}>{{ $client->nom }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Nom du site <span class="text-danger">*</span></label>
                                    <input type="text" name="nom_site" class="form-control" value="{{ old('nom_site') }}" required>
                                </div>
                                <div class="col-md-6">
                    ...
                    <div class="card form-card mb-4">
                        <div class="card-body">
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-success"><i class="bi bi-check-circle me-2"></i>Créer</button>
                                <a href="{{ route('admin.entreprise.sites.index') }}" class="btn btn-outline-secondary">Retour</a>
                            </div>
                        </div>
                    </div>
                </div>
