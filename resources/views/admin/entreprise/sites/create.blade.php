...
<div class="container-fluid px-4">
    <div class="page-header animate-fade-in">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h3><i class="bi bi-geo-alt me-2"></i>Nouveau Site</h3>
            </div>
            <div class="col-md-6">
    ...
    <form action="{{ route('admin.entreprise.sites.store') }}" method="POST" class="animate-fade-in" style="animation-delay: 0.1s;">
        @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="nom_site" class="form-control" value="{{ old('nom_site') }}" placeholder="Ex: Site principal" required>
                                @error('nom_site')
                                <div class="help-text text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" name="code_site" class="form-control" value="{{ old('code_site') }}" placeholder="Auto-généré si vide">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="niveau_risque" class="form-select">
                                    <option value="faible" {{ old('niveau_risque') == 'faible' ? 'selected' : '' }}>Faible</option>
                                    <option value="moyen" {{ old('niveau_risque') == 'moyen' ? 'selected' : '' }}>Moyen</option>
                                    <option value="haut" {{ old('niveau_risque') == 'haut' ? 'selected' : '' }}>Haut</option>
                                    <option value="critique" {{ old('niveau_risque') == 'critique' ? 'selected' : '' }}>Critique</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" name="adresse" class="form-control" value="{{ old('adresse') }}" placeholder="Adresse complète" required>
                                @error('adresse')
                                <div class="help-text text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="commune" class="form-control" value="{{ old('commune') }}" placeholder="Ex: Cotonou">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Quartier</label>
                                <input type="text" name="quartier" class="form-control" value="{{ old('quartier') }}" placeholder="Ex: Akando">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="contact_nom" class="form-control" value="{{ old('contact_nom') }}" placeholder="Nom complet">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Téléphone</label>
                                <input type="text" name="contact_telephone" class="form-control" value="{{ old('contact_telephone') }}" placeholder="+229 XX XX XX XX">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Email</label>
                                <input type="email" name="contact_email" class="form-control" value="{{ old('contact_email') }}" placeholder="email@exemple.com">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card form-card mb-4">
                    ...
                    <div class="card-body">
                        <div class="form-check form-switch mb-3">
                            <input type="checkbox" name="est_actif" id="est_actif" class="form-check-input" value="1" {{ old('est_actif', true) ? 'checked' : '' }}>
