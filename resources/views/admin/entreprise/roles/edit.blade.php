...
<div class="container-fluid px-4 py-4">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
        <div>
            <h1 class="r-page-title mb-1">Gérer les Rôles</h1>
            <p class="r-page-sub mb-0">
                <strong style="color:var(--r-text);">{{ $employe->nomComplet }}</strong>
                <span style="margin: 0 .35rem; color:var(--r-border);">·</span>
                {{ $employe->poste }}
            </p>
        </div>
        <a href="{{ route('admin.entreprise.roles.index') }}" class="btn-r-ghost">
    ...
    <form action="{{ route('admin.entreprise.roles.update', $employe->id) }}" method="POST">
        ...
        <div class="r-card mb-4">
            ...
            <div class="r-card-body">
                ...
                <div class="row g-2">
                    ...
                    @php $hasRole = $employe->hasRole($role->name); @endphp
        ...
        <div class="d-flex flex-wrap gap-2">
            ...
            <a href="{{ route('admin.entreprise.roles.index') }}" class="btn-r-ghost">Annuler</a>
        </div>
    </form>
