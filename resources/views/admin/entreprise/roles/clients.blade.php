...
<style>
    ...
    :root[data-bs-theme="dark"] {
            ...
            --r-success:    #4ade80;
            --r-success-bg: rgba(74,222,128,.1);
            --r-info:       #22d3ee;
    ...
    .r-tab {
        ...
        color: var(--r-text-muted); text-decoration: none;
    ...
    .r-table td {
        padding: .75rem 1rem;
        font-size: .875rem; color: var(--r-text);
        border-bottom: 1px solid var(--r-border);
...
<div class="container-fluid px-4 py-4">
    ...
    <div class="mb-4">
        ...
        <p class="r-page-sub mb-0">Gérez les rôles de vos clients.</p>
    </div>

    {{-- Tabs --}}
    <nav class="r-tabs">
        <a href="{{ route('admin.entreprise.roles.index') }}" class="r-tab">
            <i class="bi bi-people"></i> Employés
        </a>
        <a href="{{ route('admin.entreprise.roles.clients') }}" class="r-tab active">
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center gap-2">
                                <div class="r-avatar">{{ strtoupper(substr($client->nomAffichage, 0, 2)) }}</div>
                                <div class="r-name">{{ $client->nomAffichage }}</div>
                            </div>
                        </td>
                        <td style="color:var(--r-text);font-size:.85rem;">{{ $client->email }}</td>
                        <td><span class="r-badge r-badge-info">{{ $client->typeLabel }}</span></td>
                        <td>
                        ...
                        @can('manage_user_roles')
                        <td>
                            <a href="{{ route('admin.entreprise.roles.edit-client', $client->id) }}" class="btn-r-outline">
