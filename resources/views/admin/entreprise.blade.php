                ...
                <div class="dashboard-card p-4">
                    ...
                    <div class="row g-3">
                        <div class="col-6 col-md-3">
                            <a href="{{ route('admin.entreprise.employes.create') }}" class="quick-action-btn">
                                <i class="bi bi-person-plus text-primary"></i>
                                <span>Nouvel Employé</span>
                            </a>
                        </div>
                        <div class="col-6 col-md-3">
                            <a href="{{ route('admin.entreprise.clients.create') }}" class="quick-action-btn">
                                <i class="bi bi-person-vcard-add text-success"></i>
                                <span>Nouveau Client</span>
                            </a>
                        </div>
                        <div class="col-6 col-md-3">
                            <a href="{{ route('admin.entreprise.contrats.index') }}" class="quick-action-btn">
                                <i class="bi bi-file-earmark-plus text-warning"></i>
                                <span>Nouveau Contrat</span>
                            </a>
                        </div>
                        <div class="col-6 col-md-3">
                            <a href="{{ route('admin.entreprise.affectations.index') }}" class="quick-action-btn">
            ...
            <div class="col-lg-8">
                <div class="dashboard-card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <a href="{{ route('admin.entreprise.affectations.index') }}" class="btn btn-sm btn-outline-success">Voir tout</a>
                    </div>
